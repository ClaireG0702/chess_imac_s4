...
enum class GameEventType {
    ...
    EpidemicTransform, // Poisson - Épidémie de transformations
    Furry,             // UniformDiscrete - Sélection aléatoire
...
public:
    ...
    // Événement: Épidémie (Poisson)
    int getEpidemicTransformCount();
    
    // Événement: Furry (UniformDiscrete)
